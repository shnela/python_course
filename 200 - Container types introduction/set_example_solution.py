...
def detect_new_and_deleted_entries(prev_elements, current_elements) -> Tuple[List, List]:
    ...
    prev_elements, current_elements = set(prev_elements), set(current_elements)
    new_elements = current_elements - prev_elements
    deleted_elements = prev_elements - current_elements
    return list(new_elements), list(deleted_elements)
...
def detect_non_modified_elements(prev_elements, current_elements) -> List:
    ...
    return list(set(prev_elements) & set(current_elements))
